...
<body>
   ...
   <ul class="content-home">
		<?php
			echo"<h2 style='float: right; color:#F9D9BE '>Hello $first_name</h2>
			<h3></h3>
			...
			<li>Email: $email</li>
			<form style='width: 55%; float:right;' method='post' action='logout.php'>
			  <input type='submit' value='Logout' style='width: 26%;
    color: #000;
    font-size: 1em;
    background: #F9D9BE;
   ...
   <div class="footer">
   	 <div class="container">
			...
			<h3>Newsletter</h3>
			<p>Enter your email for and subscribe for the latest tech news</p>
			<form>
	    ...
	    <div class="clearfix"></div>
	    <div class="copy">
           <p> &copy; 2020 Mobix. All Rights Reserved | Design by <a href="http://w3layouts.com/" target="_blank">W3layouts</a></p>
	    </div>
   	</div>
   </div>
</body>
