      ...
      <div class="col-md-9 single_top">
		...
		$row=mysqli_fetch_array($result, MYSQLI_ASSOC);?>
			<div class="flexslider">
					 <ul class="slides">
					 <?php
						echo"<li data-thumb=images/$row[image]>
							<img src=images/$row[image] />"
							?>
						</li>
						<?php
						echo"<li data-thumb=images/$row[image_1]>
							<img src=images/$row[image_1] />"
							?>
						</li>
						<?php
						echo"<li data-thumb=images/$row[image_2]>
							<img src=images/$row[image_2] />"
							?>
						</li>
		...
		<div class="cont1 span_2_of_a1 simpleCart_shelfItem">
				...
				<?php echo"<h1>$row[model]</h1>"; ?>
				
				<p class="availability">Availability: <span class="color">In stock</span></p>
			    <div class="price_single">
				<?php
					$reduced_price=$row['price']*0.85;
				  echo"<span class='reducedfrom'>$$reduced_price</span>";
				  echo"<span class='amount item_price actual'>$$row[price]</span>";
				  ?>
				</div>
				<h2 class="quick">Quick Overview:</h2>
				<?php echo"<p class='quick_desc'> $row[description]</p>";
				?>
			    <div class="wish-list">
				 	<ul>
				...
				echo"<a href=add_to_cart.php?productID=".$row['productID']." class='btn btn-primary btn-normal btn-inline btn_form button item_add item_1' target='_self'>Add to cart</a>";?>
			</div>
		    <div class="clearfix"> </div>
		</div>
        <div class="sap_tabs">	
		...
		<div class="col-md-3 tabs">
		  ...
		  <?php
					...
					$query = "SELECT productID, brand, model, price, image FROM products WHERE brand='$row[brand]' Limit 3";
						$result=mysqli_query($link, $query);
					while($row=mysqli_fetch_array($result, MYSQLI_ASSOC))
					{
	      echo"<ul class='product'>
	      	<li class='product_img'><img src=images/$row[image] class='img-responsive' alt=''/></li>
	      	<li class='product_desc'>
	      		<h4><a href='single.php?productID=".$row['productID'].">".$row['model']."'	>$row[model]</a></h4>
	      		<p class='single_price'>$$row[price]</p>
